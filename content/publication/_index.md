...
**Books**
1. **Yuchao Zhang**, Ke Xu. [Network Management in Cloud and Edge Computing.](./doc/2023-wcnc-fravar.pdf) Springer. ISBN: 978-981-15-0137-1
...
[48] Yuchao Zhang#, Huahai Zhang, Peizhuang Cong, Wendong Wang, Ke Xu. Grandet: Cost-aware Traffic Scheduling without Prior Knowledge in SD-WAN. IEEE/ACM International Symposium on Quality of Service (IWQoS), 19-21 June 2023. Orlando, FL, USA.  Best Paper Finalist
[47] Peizhuang Cong, Yuchao Zhang#, Wendong Wang, Ke Xu. SOHO-FL: A Fast Reconvergent Intra-domain Routing Scheme Using Federated Learning. IEEE Network Magazine. (JCR Q2) 
...
[45] Yuchao Zhang#, Xiaoxi Xue, Haorang Zhang, Zekun Han, Wenlong Wang. Design of Intelligent Evaluation System Based on BlazePose for Students' Physical Examination (in Chinese). The 27th Global Chinese Conference on Computers in Education (GCCCE 2023). 27-31 May, 2023. Beijing Normal University, Beijing, China.
[44] Haoqiang Huang, Yuchao Zhang#, Ran Wang, Qiao Xiang, Wendong Wang, Xirong Que, Ke Xu. FRAVaR: A Fast Recovery Framework for Inter-DC Network. 2023 IEEE Wireless Communications and Networking Conference (WCNC) 26-29 March 2023. Glasgow, Scotland, UK. 
...
2021
[35] Pengmiao Li, Yuchao Zhang#, Wendong Wang, Kaichuan Zhao, Bo Lian, Ke Xu, Zhili Zhang. Frend for Edge Servers: Reduce Server Number! Keeping Service Quality! The 2021 IEEE Internatioanl Conference on High Performance Computing and Communications (HPCC). 17-19 Dec., 2021, Haikou, China.
[34] Fuliang Li, Naigong Zheng, Yuchao Zhang#, Yishuang Ning, Xingwei Wang#. Queueing Theory over OpenvSwitch: Performance Analysis and Optimization. 2021 International Conference on Web Service (ICWS).  Dec.ember 10-14 2021. (Virtual Conference)
[33] Pengmiao Li, Yuchao Zhang#, Huahai Zhang, Wendong Wang, Ke Xu, Zhili Zhang. CRATES: A Cache Replacement Algorithm for Low Access Frequency Period in Edge Servers. The 17th International Conference on Mobility, Sensing and Networking (MSN), December 13-15, 2021, Exeter, UK.
[32] Bo Yi, Fuliang Li, Yuchao Zhang#, Xingwei Wang. TPA based Content Popularity Prediction for Caching and Routing in Edge-Cloud Cooperation Network. 2021 IEEE Global Communications Conference (GlobeCom), December 7-11, Madrid, Spain. (Hybrid: In-Person and Virtual Conference) 
[31] 王然,  张宇超#, 王文东, 徐恪, 崔来中. 基于预测的数据中心间混合流量调度算法. 计算机研究与发展[J], 2021. (CCF 推荐中文期刊 A 类)
[30] Yuchao Zhang, Peizhuang Cong, Bin Liu, Wendong Wang, Ke Xu. AIR: An AI-based TCAM Entry Replacement Scheme for Routers. 2021 IEEE/ACM 29th International Symposium on Quality of Service (IWQoS), 25-28 June, 2021, Tokyo, Japan. (Virtual Conference) 
[29] Peizhuang Cong, Yuchao Zhang#, Zheli Liu, Thar Baker, Hissam Tawfik, Wendong Wang ,Ke Xu, Ruidong Li, Fuliang Li. A Deep Reinforcement Learning-based Multi-Optimality Routing Scheme for Dynamic IoT Networks. Computer Networks (CN), 2021, 192: 108057. DOI: https://doi.org/10.1016/j.comnet.2021.108057. (JCR Q2, CCF B)
[28] Peizhuang Cong, Yuchao Zhang#, Wendong Wang, Ning Zhang. DND:Driver Node Detection for Control Message Diffusion in Smart Transportations. IEEE Transactions on Network and Service Management (TNSM). (JCR Q2)
[27] Peizhuang Cong, Yuchao Zhang#, Wendong Wang, Ke Xu, Ruidong Li, Fuliang Li. A Deep Reinforcement Learning-based Routing Scheme with Two Modes for Dynamic Networks. 2021 IEEE International Conference on Communications (ICC). 14-23 June 2021, Montreal. (Virtual Conference) 
[26] Shiyan Zhang, Yuchao Zhang#, Xiangyang Gong, Ran Wang. FreeVM: A Server Release Algprithm in DataCenter Netwrok. 2021 IEEE International Conference on Communications (ICC). 14-23 June 2021, Montreal. (Virtual Conference) 
[25] Yuchao Zhang#, Xiaohui Nie, Junchen Jiang, Wendong Wang, Ke Xu, Youjian Zhao, Reed Martin, Kai Chen, Haiyang Wang, Guang Yao. BDS+: An Inter-Datacenter Data Replication System with Dynamic Bandwidth Seperation. IEEE/ACM Transaction on Networking (ToN). 2021, 29(2): 918-934. DOI: 10.1109/TNET.2021.3054924. (CCF A)
...
[7] Yuchao Zhang, Yusen Li, Ke Xu, Dan Wang, Minghui Li, Xuan Cao, Qingqing Liang. A Communication-aware Container Re-distribution Approach for High Performance VNFs. IEEE 37th International Conference on Distributed Computing Systems (ICDCS) 2017.  pp. 1555-1564. 5-8 June, Atlanta, USA. 

2016
[6] Yuchao Zhang, Ke Xu, Guang Yao, Miao Zhang, Xiaohui Nie. “A Cross-DR scale Large Data Transmission Scheduling System” [C] Proceedings of the 2016 conference on ACM SIGCOMM 2016 Poster. ACM, 2016: 553-554. 22-26 August, Florianopolis, Brazil. 
[5] Tong Li, Ke Xu, Meng Shen, Haiyang Wang, Kun Yang, Yuchao Zhang. "Towards Minimal Tardiness of Data-intensive Applications in Heterogeneous Networks".  The 25th International Conference on Computer Communication and Networks (ICCCN) 2016. 1-4 August, Waikoloa, Hawaii, USA.
[4] Yuchao Zhang, Ke Xu, Xuelin Shi, Haiyang, Jiangchuan Liu, Yong Wang. "﻿Continuous Double Auction for Cloud Market: Pricing and Bidding Analysis﻿", IEEE Wireless Communications and Networking Conference (WCNC), 2016. 3-6 April, Doha, Qatar. 

2015
[3] Yuchao Zhang, Ke Xu, Haiyang Wang, Meng Shen. "Towards Shorter Task Completion Time in Datacenter Networks"[C]//2015 IEEE 34th International Performance Computing and Communications Conference (IPCCC). IEEE, 2015: 1-8. 14-16 December, Nanjing, China.
[2] Yuchao Zhang, Ke Xu, Haiyang Wang, Jiangchuan Liu, Yifeng Zhong, Wenlong Chen. "﻿Performance and Incentive of Teamwork-based Channel Allocation in Spectrum Access Networks﻿"[C]//In IEEE 23rd International Symposium on Quality of Service (IWQoS). IEEE, 2015, pp. 255-260. 15-16 June, Portland, Oregon, USA. 

2014
[1] Ke Xu, Yuchao Zhang, xuelin Shi,  Haiyang Wang, Yong Wang, Meng Shen."Online Combinatorial Double Auction for Mobile Cloud Computing Markets"[C]//2014 IEEE 33rd International Performance Computing and Communications Conference (IPCCC). IEEE, 2014: 1-8. 5-7 December, Austin, Texas, USA.
 Software Copyright
1. Shuang Wu, Yuchao Zhang. Edge Server Discovery System base on 5G Architecture. China Copyright Protection Center. 2021R11L1260945.
2. Xiaotian Wang, Yuchao Zhang. An IoT Data Management System based on Nested-chain in HyperLedger Fabric. 2021SR1804253.
 202010388220.1Patents.
...
IETF Draft
1. Ke Xu, Yuchao Zhang, Meng Shen, Zhicheng Ge, Xiangxiang Wang. Efficient Transmission in Virtual Multi-path TCP.
2. Yuchao Zhang, Peizhuang Cong, Haiyang Jiang, Lei Wang, Wendong Wang, Dan Li. I2BGP: Desensitize Intra-domain Information for Inter-domain Routing.
